...
class _HomeScreenState extends State<HomeScreen> {
  ...
  Widget build(BuildContext context) {
    final displayName = widget.userName.isEmpty
        ? "Mahasiswa"
        : widget.userName;
                  ...
                  GridView.count(
                    ...
                    children: [
                      _featureCard(
                        context,
                        title: "Chat AI",
                        subtitle: "Teman untuk bercerita",
                      ...
                      _featureCard(
                        context,
                        title: "Tips Mental",
                        subtitle: "Rawat dirimu setiap hari",
                      ...
                      _featureCard(
                        context,
                        title: "Konselor",
                        subtitle: "Temukan bantuan profesional",
                        icon: Icons.people_alt_rounded,
                        color: const Color(0xFF7DDC91),
                        page: const CounselorScreen(),
                      ),
                    ],
                  ),
